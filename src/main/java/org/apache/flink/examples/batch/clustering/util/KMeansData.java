...
package org.apache.flink.examples.batch.clustering.util;


import org.apache.flink.api.java.DataSet;
import org.apache.flink.api.java.ExecutionEnvironment;
import org.apache.flink.examples.batch.clustering.KMeans;
import org.apache.flink.examples.batch.clustering.KMeans.Centroid;
...
public class KMeansData {
	...
	public static DataSet<KMeans.Point> getDefaultPointDataSet(ExecutionEnvironment env) {
		List<KMeans.Point> pointList = new LinkedList<KMeans.Point>();
		for (Object[] point : POINTS) {
			pointList.add(new KMeans.Point((Double) point[0], (Double) point[1]));
		}
