...
import org.apache.flink.examples.batch.ml.LinearRegression;
import org.apache.flink.examples.batch.ml.LinearRegression.Params;
...
public class LinearRegressionData {
	...
	public static DataSet<Params> getDefaultParamsDataSet() {
		return getDefaultParamsDataSet();
	}
